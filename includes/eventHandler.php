      ...
      class myEventHandler implements EventHandlerInterface{
          ...
          function onInit($initializationData){
              // Save the transaction to your DB.
                $this->order->add_order_note('Payment initialized via EduPay');
          ...
          function onSuccessful($transactionData){
              ...
              if($transactionData->chargecode === '00' || $transactionData->chargecode === '0'){
                  if($transactionData->currency == $this->order->get_order_currency() && $transactionData->amount == $this->order->order_total){
                      ...
                      $this->order->add_order_note('Payment was successful on EduPay');
          ...
          function onRequery($transactionReference){
              ...
              $this->order->add_order_note('Confirming payment on EduPay');
          }
          ...
          function onRequeryError($requeryResponse){
              // Do something, anything!
              $this->order->add_order_note('An error occured while confirming payment on EduPay');
              $this->order->update_status( 'on-hold' );
                $customer_note  = 'Thank you for your order.<br>';
